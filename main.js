...
module.exports = class Covalent {
    ...
    async getTokenPrices({
        ...
        const response = await this.client.PricingService.getTokenPrices(...Object.values(obj));
